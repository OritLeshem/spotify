...
export function HomePageSvg() {
  return <svg role="img" height="24" width="24" aria-hidden="true" viewBox="0 0 24 24" data-encore-id="icon">
    <path fill="currentcolor" d="M13.5 1.515a3 3 0 0 0-3 0L3 5.845a2 2 0 0 0-1 1.732V21a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1v-6h4v6a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V7.577a2 2 0 0 0-1-1.732l-7.5-4.33z"></path>
  </svg>
}
...
export function CreatePlaylist() {
  return <span className="create-playlist">
...
export function LikedSongs() {
  return <span className="liked-songs">
    <svg role="img" height="12" width="12" aria-hidden="true" viewBox="0 0 16 16" data-encore-id="icon">
      <path fill="currentcolor" d="M15.724 4.22A4.313 4.313 0 0 0 12.192.814a4.269 4.269 0 0 0-3.622 1.13.837.837 0 0 1-1.14 0 4.272 4.272 0 0 0-6.21 5.855l5.916 7.05a1.128 1.128 0 0 0 1.727 0l5.916-7.05a4.228 4.228 0 0 0 .945-3.577z"></path>
    </svg>
  </span>
}
...
export function BackBtn() {
  ...
  return <button className="back-btn">
...
export function ForwardBtn() {
  return <button className="forward-btn">
    <svg role="img" height="16" width="16" aria-hidden="true" viewBox="0 0 16 16" data-encore-id="icon">
      <path fill="currentcolor" d="M4.97.47a.75.75 0 0 0 0 1.06L11.44 8l-6.47 6.47a.75.75 0 1 0 1.06 1.06L13.56 8 6.03.47a.75.75 0 0 0-1.06 0z"></path>
    </svg>
  </button>
}
...
export function UserBtn() {
  ...
  return <button className="user-btn">
    ...
    <h3>puki</h3>
    <svg role="img" height="16" width="16" aria-hidden="true" viewBox="0 0 16 16" data-encore-id="icon" className="arrow">
      <path fill="currentcolor" d="m14 6-6 6-6-6h12z"></path>
    </svg>
  </button>
}